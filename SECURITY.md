...
## Supported Versions
Ensure you are using the latest version of Sentinel-Scan for up-to-date vulnerability definitions and platform fixes.
...
As a cybersecurity platform, we take the security of Sentinel-Scan extremely seriously.
