  ...
  const [sources, setSources] = useState([
    {
      ...
      status: import.meta.env.VITE_VIRUSTOTAL_ENABLED === 'true' ? 'connected' : 'disconnected',
    ...
    },
    {
      ...
      status: import.meta.env.VITE_ABUSEIPDB_ENABLED === 'true' ? 'connected' : 'disconnected',
      lastSync: '1 hour ago',
      logo: '🌐'
    },
    {
      ...
      status: import.meta.env.VITE_SHODAN_ENABLED === 'true' ? 'connected' : 'disconnected',
      lastSync: 'Never',
      logo: '👁️'
    },
    {
      ...
      status: import.meta.env.VITE_ALIENVAULT_ENABLED === 'true' ? 'connected' : 'disconnected',
      lastSync: '5 mins ago',
      logo: '👽'
    }
  ]);
