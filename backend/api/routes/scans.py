...
from backend.models.scan import ScanDocument, ScanRequest, ScanResponse, ScanStatus
...
async def create_scan(
    ...
    scan_doc = ScanDocument(
        ...
        scan_types=[st.value for st in scan_request.scan_types],
    ...
    background_tasks.add_task(
        ...
        scan_types=scan_doc.scan_types,
...
async def get_scan(scan_id: str, db: AsyncIOMotorDatabase = Depends(get_db)):
    ...
    return ScanResponse(
        ...
        target=scan["target"],
        scan_types=[st for st in scan["scan_types"]],
